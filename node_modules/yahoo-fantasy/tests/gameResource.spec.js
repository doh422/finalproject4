...
describe ("resource: gameResource", function(){
  var yf = new YahooFantasy(
    'dj0yJmk9aWFKclRoanZjaUoxJmQ9WVdrOVdUUjBUVE5VTXpRbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD01MA--',
    '6fe57f08a941037c174473ca0ed1fc87ba7cadcc')
    , game = yf.game;
  ...
  it ("should have a leagus function", function() {
  ...
  beforeEach(function() {
    ...
    //   .get(/\/fantasy\/v2\/game\/.*/) // '/fantasy/v2/game/328/metadata?format=json') // /\/fantasy\/v2\/game\/.*/)
    //   .reply(200, {});
  });
